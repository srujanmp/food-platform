...
import { UtensilsCrossed, LayoutDashboard, Book, ClipboardList, LogOut, Store } from 'lucide-react';
import { toast } from 'sonner';
import { cn } from '@/lib/utils';

const navItems = [
  { to: '/owner/dashboard', label: 'Dashboard', icon: LayoutDashboard },
  { to: '/owner/restaurant', label: 'My Restaurant', icon: Store },
  { to: '/owner/restaurant/menu', label: 'Menu', icon: Book },
    ...
    <div className="min-h-screen flex">
      <aside className="w-64 bg-sidebar text-sidebar-foreground border-r border-sidebar-border flex flex-col">
        <div className="p-4 flex items-center gap-2 border-b border-sidebar-border">
          ...
          <span className="font-display font-bold">Owner Portal</span>
        </div>
